...
public class HelpCommand {
    ...
    public List<MessageEmbed> pages() {
        ...
        pages.add(new EmbedBuilder()
                .setTitle(translation.help().embedPageOneTitle())
                .setColor(0x000000)
                .setDescription(colorTool.parse(translation.help().embedPageOneBody()).trim())
                .setTimestamp(Instant.now())
                .setFooter(translation.help().embedFooterText(), translation.help().embedFooterImg())
                .build());

        pages.add(new EmbedBuilder()
                .setTitle(translation.help().embedPageTwoTitle())
                .setColor(0x000000)
        ...
        pages.add(new EmbedBuilder()
                .setTitle(translation.help().embedPageThreeTitle())
                .setColor(0x000000)
        ...
        pages.add(new EmbedBuilder()
                .setTitle(translation.help().embedPageFourTitle())
                .setColor(0x000000)
        ...
        pages.add(new EmbedBuilder()
                .setTitle(translation.help().embedPageFiveTitle())
                .setColor(0x000000)
        ...
        pages.add(new EmbedBuilder()
                .setTitle(translation.help().embedPageSixTitle())
                .setColor(0x000000)
    ...
    public Collection<ItemComponent> actionRow(int page) {
