...
public class VerifyTemplate {
    ...
    public VerifyTemplate(Config config, Translation translation) {
        this.config = config;
        this.translation = translation;
    }

    public void pasteTemplate(SlashCommandInteractionEvent event) {
        new VerifyMessageHandler(event.getJDA(), config, translation).sendTemplate(event.getChannel().asTextChannel(), event.getGuild());
