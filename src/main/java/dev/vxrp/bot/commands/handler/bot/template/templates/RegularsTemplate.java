...
public class RegularsTemplate {
    private final Config config;
    private final Translation translation;

    public RegularsTemplate(Config config, Translation translation) {
        this.config = config;
        this.translation = translation;
    }

    public void pasteTemplate(SlashCommandInteractionEvent event) {
        new RegularsMessageHandler(event.getJDA(), config, translation).sendRegulars(event.getChannel().asTextChannel());
